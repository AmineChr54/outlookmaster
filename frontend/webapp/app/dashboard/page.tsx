...
export default function DashboardPage() {
  ...
  const [mailbox, setMailbox] = useState('INBOX');  // unused but kept
  ...
  // New effect: fetch raw emails on mount
  useEffect(() => {
    ...
    <div className="relative font-sans min-h-screen flex flex-col">
      ...
      <div className="relative z-10 min-h-screen flex flex-col bg-transparent">
        ...
        <header className="bg-blue-700 text-white p-4 text-xl font-bold shadow flex items-center gap-4 h-15">
          ...
          <button onClick={logout} className="ml-auto bg-primary text-bg px-3 py-1 rounded cursor-pointer hover:bg-accent">Logout</button>
        </header>
